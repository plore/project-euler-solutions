def num_rectangles(dim_x: int, dim_y: int) -> int:
    res = 0
    # For each rectangle with shape (x, y), count how many positions the lower right corner can occupy.
...
# This yields 2000 as the maximal extent as well as a starting epsilon for the nearest solution
eps = 1000
